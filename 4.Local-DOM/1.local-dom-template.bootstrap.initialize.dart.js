...
var dart=[["","",,K,{
"^":"",
c5:function(){$.$get$c_().J(0,[new A.cD(C.r,S.dl())])
var z=P.af(["is","local-dom-template"])
$.$get$N().W("Polymer",[E.an(z)])
return}},1],["","",,H,{
"^":"",
e9:{
"^":"c;a"}}],["","",,J,{
...
af:function(a,b){return this.ag(a,b,null)}}}],["","",,S,{
"^":"",
eu:[function(){var z=P.af(["is","local-dom-template"])
$.$get$N().W("Polymer",[E.an(z)])},"$0","dl",0,0,1]}]]
setupProgram(dart,0)
...
if(typeof dartMainRunner==="function")dartMainRunner(K.c5,[])
else K.c5([])})})()