...
dW:function(a){throw H.b(new P.cs("Cyclic initialization for static "+H.a(a)))},
...
ae:function(a,b){return this.af(a,b,null)}}}],["","",,G,{
"^":"",
c5:function(){var z=P.af(["is","event-listener","listeners",P.af(["tap","regularTap","track","track","special.tap","specialTap"]),"track",new G.dP(),"regularTap",new G.dQ(),"specialTap",new G.dR()])
$.$get$P().a5("Polymer",[E.b_(z)])},
dP:{
"^":"e:10;",
$2:[function(a,b){P.dT(b)},null,null,4,0,null,1,2,"call"]},
dQ:{
"^":"e:3;",
$2:[function(a,b){window.alert("Thank you for tapping")},null,null,4,0,null,1,2,"call"]},
dR:{
"^":"e:3;",
$2:[function(a,b){window.alert("It was special tapping")},null,null,4,0,null,1,2,"call"]}},1]]
setupProgram(dart,0)
...
if(typeof dartMainRunner==="function")dartMainRunner(G.c5,[])
else G.c5([])})})()