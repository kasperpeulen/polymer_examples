...
z=J.aT(b)
if(z.M(b,0))throw H.b(P.ag(b,null,null))
if(z.L(b,c))throw H.b(P.ag(b,null,null))
if(J.c9(c,a.length))throw H.b(P.ag(c,null,null))
...
$isC:1}}],["","",,H,{
"^":"",
co:function(){throw H.b(new P.a3("Cannot modify unmodifiable Map"))},
...
return z},
c7:[function(){return J.ap(this.dartException)},null,null,0,0,null],
...
w=x&65535
if((C.c.ar(x,16)&8191)===10)switch(w){case 438:return z.$1(H.ay(H.a(y)+" (Error "+w+")",null))
...
else throw H.b(new P.de("Unsupported number of arguments for wrapped closure"))},null,null,14,0,null,13,14,15,16,17,18,19],
...
x=H.bs(z).r}else x=c
w=d?Object.create(new H.d4().constructor.prototype):Object.create(new H.as(null,null,null,null).constructor.prototype)
...
else if(u&&typeof x=="function"){q=t?H.b2:H.at
...
return v},
ci:function(a,b,c,d){var z=H.at
...
dS:function(a){throw H.b(new P.cq("Cyclic initialization for static "+H.a(a)))},
...
el:function(a){var z=$.aV
return"Instance of "+(z==null?"<Unknown>":z.$1(a))},
ek:function(a){return H.J(a)},
...
return b},
aZ:function(a){return J.an(a,!1,null,!!a.$isav)},
...
dR:function(a,b,c){return a.indexOf(b,c)>=0},
cn:{
"^":"da;a",
$asB:I.a5,
$isB:1},
...
v.l(0,new H.aF(t),x[s])}return H.a7(new H.cn(v),[P.a2,null])}},
d0:{
"^":"c;a,b,c,d,e,f,r,x",
...
return new H.d8(a.replace('\\$arguments\\$','((?:x|[^x])*)').replace('\\$argumentsExpr\\$','((?:x|[^x])*)').replace('\\$expr\\$','((?:x|[^x])*)').replace('\\$method\\$','((?:x|[^x])*)').replace('\\$receiver\\$','((?:x|[^x])*)'),y,x,w,v,u)},ai:function(a){return function($expr$){var $argumentsExpr$='$arguments$'
...
static:{at:function(a){return a.a},b2:function(a){return a.c},ch:function(){var z=$.M
...
return z}}],["","",,P,{
"^":"",
be:function(){return H.a7(new H.ax(0,null,null,null,null,null,0),[null,null])},
aA:function(a){return H.dr(a,H.a7(new H.ax(0,null,null,null,null,null,0),[null,null]))},
...
an:function(a,b){if(Math.abs(a)>864e13)throw H.b(P.aq(a))},
static:{cr:function(a,b){var z=new P.aa(a,b)
z.an(a,b)
...
u=P.V(this.b)
return w+v+": "+H.a(u)},
static:{aq:function(a){return new P.H(!1,null,null,a)},cf:function(a,b,c){return new P.H(!0,a,b,c)}}},
br:{
"^":"H;e,f,a,b,c,d",
...
h:["am",function(a){return H.af(this)}],
...
if(b===!0){z=[c]
C.a.U(z,d)
d=z}y=P.a_(J.cd(d,P.dI()),!0)
return P.a4(H.bo(a,y))},null,null,8,0,null,20,21,22,23],
...
z=J.h(a)
if(!!z.$isD)return a.a
if(!!z.$isar||!!z.$isac||!!z.$isaz||!!z.$isau||!!z.$isN||!!z.$isr||!!z.$isaH)return a
if(!!z.$isaa)return H.m(a)
if(!!z.$isad)return P.bO(a,"$dart_jsFunction",new P.dh())
return P.bO(a,"_$dart_jsObject",new P.di($.$get$aL()))},"$1","aX",2,0,0,1],
...
z=!!z.$isar||!!z.$isac||!!z.$isaz||!!z.$isau||!!z.$isN||!!z.$isr||!!z.$isaH}else z=!1
if(z)return a
else if(a instanceof Date)return P.cr(a.getTime(),!1)
else if(a.constructor===$.$get$aL())return a.o
else return P.aj(a)}},"$1","dI",2,0,9,1],
aj:function(a){if(typeof a=="function")return P.aN(a,$.$get$aI(),new P.dk())
...
D:{
"^":"c;a",
i:["ak",function(a,b){if(typeof b!=="string"&&typeof b!=="number")throw H.b(P.aq("property is not a String or num"))
return P.aK(this.a[b])}],
l:["al",function(a,b,c){if(typeof b!=="string"&&typeof b!=="number")throw H.b(P.aq("property is not a String or num"))
this.a[b]=P.a4(c)}],
gp:function(a){return 0},
n:function(a,b){if(b==null)return!1
...
static:{cI:function(a,b){var z=P.a4(a)
...
return new A.cY(a,null,null,null)}if(!!z.$isaw)return z.G(a,new E.dq()).aa(0)
...
return new P.aw(y)}else{y=H.dp(a,"$isB",[P.C,null],"$asB")
if(y){x=P.cI(J.e($.$get$P(),"Object"),null)
z.t(a,new E.dL(x))
return x}else if(!!z.$isd7)return $.$get$c2().i(0,a)
else if(!!z.$isad)return new P.Y(P.bN(new E.dM(a),!0))}}return a},
...
return z},
l:function(a,b,c){J.ao(this.gv(),b,c)}},
dq:{
"^":"f:0;",
$1:[function(a){return E.bU(a)},null,null,2,0,null,2,"call"]},
ds:{
"^":"f:7;a,b",
...
dK:{
"^":"f:0;",
$1:[function(a){return E.aY(a)},null,null,2,0,null,2,"call"]},
dL:{
"^":"f:2;a",
$2:function(a,b){J.ao(this.a,a,E.aY(b))}},
dM:{
"^":"f:8;a",
...
ae:function(a,b){return this.af(a,b,null)}}}],["","",,S,{
"^":"",
c3:function(){var z=P.aA(["is","annotated-event","handleClick",new S.dP()])
$.$get$P().a5("Polymer",[E.aY(z)])},
dP:{
"^":"f:1;",
$0:[function(){window.alert("Ow!")},null,null,0,0,null,"call"]}},1]]
setupProgram(dart,0)
J.h=function(a){if(typeof a=="number"){if(Math.floor(a)==a)return J.bb.prototype
return J.cE.prototype}if(typeof a=="string")return J.ae.prototype
...
return J.G(a).i(a,b)}
J.ao=function(a,b,c){if((a.constructor==Array||H.c0(a,a[init.dispatchPropertyName]))&&!a.immutable$list&&b>>>0===b&&b<a.length)return a[b]=c
...
C.h=I.am([])
C.y=I.am([])
C.i=H.a7(new H.cp(0,{},C.y),[P.a2,null])
C.A=new H.aF("call")
C.j=H.x("B")
C.k=H.x("ad")
C.l=H.x("aa")
...
try{(void 0).$method$($argumentsExpr$)}catch(z){return z.message}}())},"bD","$get$bD",function(){return H.v(H.bE(null))},"bC","$get$bC",function(){return H.v(function(){try{null.$method$}catch(z){return z.message}}())},"bI","$get$bI",function(){return H.v(H.bE(void 0))},"bH","$get$bH",function(){return H.v(function(){try{(void 0).$method$}catch(z){return z.message}}())},"O","$get$O",function(){return[]},"P","$get$P",function(){return P.aj(self)},"aJ","$get$aJ",function(){return H.bW("_$dart_dartObject")},"aI","$get$aI",function(){return H.bW("_$dart_dartClosure")},"aL","$get$aL",function(){return function DartObject(a){this.o=a}},"c2","$get$c2",function(){var z=$.$get$P()
return P.aA([C.D,J.e(z,"Number"),C.B,J.e(z,"Number"),C.m,J.e(z,"Number"),C.o,J.e(z,"Boolean"),C.n,J.e(z,"String"),C.p,J.e(z,"Array"),C.l,J.e(z,"DateTime"),C.j,J.e(z,"Object"),C.C,J.e(z,"Object"),C.k,J.e(z,"JsFunction")])},"aR","$get$aR",function(){var z=$.$get$P()
return P.aA([J.e(z,"Number"),C.m,J.e(z,"Boolean"),C.o,J.e(z,"String"),C.n,J.e(z,"Array"),C.p,J.e(z,"DateTime"),C.l,J.e(z,"Object"),C.j,J.e(z,"JsFunction"),C.k])},"aQ","$get$aQ",function(){return P.be()}])
...
try{if(x===z){this[a]=y
try{x=this[a]=c()}finally{if(x===z)this[a]=null}}else if(x===y)H.dS(d||a)
...
if(typeof dartMainRunner==="function")dartMainRunner(S.c3,[])
else S.c3([])})})()