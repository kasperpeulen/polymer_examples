...
dX:function(a){throw H.c(new P.cu("Cyclic initialization for static "+H.a(a)))},
...
ag:function(a,b){return this.ah(a,b,null)}}}],["","",,N,{
"^":"",
c6:function(){var z,y,x
z=P.aB(["is","extend-input","extends","input","created",new N.dU()])
y=$.$get$P()
...
z.border="1px solid red"},null,null,2,0,null,1,"call"]}},1]]
setupProgram(dart,0)
...
if(typeof dartMainRunner==="function")dartMainRunner(N.c6,[])
else N.c6([])})})()