...
e0:function(a){throw H.b(new P.cy("Cyclic initialization for static "+H.a(a)))},
...
dX:function(a,b,c){var z=b.prototype
...
ai:function(a,b){return this.aj(a,b,null)}}}],["","",,X,{
"^":"",
c8:function(){var z=P.aD(["is","initialization-order","attached",new X.dW()])
...
dW:{
"^":"e:9;",
$1:[function(a){J.ch(a,new X.dV())},null,null,2,0,null,1,"call"]},
dV:{
"^":"e:1;",
$0:[function(){P.dY(J.b3(L.ce("#sibling")))},null,null,0,0,null,"call"]}},1]]
setupProgram(dart,0)
...
if(typeof dartMainRunner==="function")dartMainRunner(X.c8,[])
else X.c8([])})})()