...
dW:function(a){throw H.b(new P.cq("Cyclic initialization for static "+H.a(a)))},
...
ae:function(a,b){return this.af(a,b,null)}}}],["","",,R,{
"^":"",
c3:function(){return N.dP()}},1],["","",,N,{
"^":"",
dP:function(){var z=P.E(["is","path-changes","properties",P.E(["company",P.E(["type",C.c,"value",P.E(["manager",P.E(["name","John"]),"secondManager",P.E(["name","Scott"])])])]),"observers",["userManagerChanged(company.manager.name)"],"userManagerChanged",new N.dQ(),"attached",new N.dR()])
$.$get$Q().a5("Polymer",[E.aY(z)])},
dQ:{
"^":"e:2;",
$2:[function(a,b){P.dT("new manager name is "+H.a(b))},null,null,4,0,null,1,26,"call"]},
dR:{
"^":"e:0;",
...
if(typeof dartMainRunner==="function")dartMainRunner(R.c3,[])
else R.c3([])})})()