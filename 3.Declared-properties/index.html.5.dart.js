...
"^":"",
c3:function(){var z=P.F(["is","deep-path-observe","properties",P.F(["company",P.F(["type",C.c,"value",P.F(["manager",P.F(["name","John"]),"secondManager",P.F(["name","Scott"])])])]),"observers",["userManagerChanged(company.manager.*)"],"userManagerChanged",new B.dP(),"attached",new B.dQ()])
