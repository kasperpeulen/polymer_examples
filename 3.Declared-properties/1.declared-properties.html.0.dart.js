...
aG:function(a,b){return this.aH(a,b,null)}}}],["","",,D,{
"^":"",
cJ:function(){var z=P.Z(["is","declared-properties","properties",P.Z(["user",C.f,"isHappy",C.h,"count",P.Z(["type",C.u,"notify",!0,"value",0])]),"listeners",P.Z(["count-changed","countHandler"]),"ready",new D.f3(),"countHandler",new D.f4()])
...
if(typeof dartMainRunner==="function")dartMainRunner(D.cJ,[])
else D.cJ([])})})()