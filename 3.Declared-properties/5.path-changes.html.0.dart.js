...
return a[b]},
k:function(a,b,c){if(!!a.immutable$list)H.l(new P.a5("indexed set"))
...
$isC:1}}],["","",,H,{
"^":"",
co:function(){throw H.b(new P.a5("Cannot modify unmodifiable Map"))},
...
return z.$1(new P.I(!1,null,null,typeof y==="string"?y.replace(/^RangeError:\s*/,""):y))}if(typeof InternalError=="function"&&a instanceof InternalError)if(typeof y==="string"&&y==="too much recursion")return new P.bv()
return a},
...
dV:function(a){throw H.b(new P.cq("Cyclic initialization for static "+H.a(a)))},
...
w=x.length-y
if(y===0)return C.j
v=H.a8(new H.ay(0,null,null,null,null,null,0),[P.a4,null])
for(u=0;u<y;++u){if(u>=z.length)return H.p(z,u)
t=z[u]
s=w+u
if(s<0||s>=x.length)return H.p(x,s)
v.k(0,new H.aF(t),x[s])}return H.a8(new H.cn(v),[P.a4,null])}},
d0:{
"^":"c;a,b,c,d,e,f,r,x",
...
static:{au:function(a){return a.a},b2:function(a){return a.c},ch:function(){var z=$.N
...
bg:{
"^":"b9;a,b",
gA:function(a){return new H.cO(null,J.U(this.a),this.b)},
...
E:function(a){return H.dr(a,H.a8(new H.ay(0,null,null,null,null,null,0),[null,null]))},
...
df:{
"^":"c;",
k:function(a,b,c){throw H.b(new P.a5("Cannot modify unmodifiable map"))},
$isB:1},
cM:{
"^":"c;",
...
z=[]
for(y=J.U(a);y.l();)z.push(y.gm())
if(b)return z
z.fixed$length=Array
return z},
dS:function(a){H.dT(a)},
cR:{
"^":"e:6;a,b",
...
u=P.X(this.b)
return w+v+": "+H.a(u)},
static:{ar:function(a){return new P.I(!1,null,null,a)},cf:function(a,b,c){return new P.I(!0,a,b,c)}}},
br:{
"^":"I;e,f,a,b,c,d",
...
static:{ah:function(a,b,c){return new P.br(null,null,!0,a,b,"Value not in range")},a2:function(a,b,c,d,e){return new P.br(b,c,!0,a,d,"Invalid value")}}},
cA:{
"^":"I;e,j:f>,a,b,c,d",
gO:function(){return"RangeError"},
...
static:{b8:function(a,b,c,d,e){var z=e!=null?e:J.V(b)
...
D:function(a,b){var z
for(z=this.gA(this);z.l();)if(J.y(z.gm(),b))return!0
return!1},
...
h:function(a){var z=this.a
return z.charCodeAt(0)==0?z:z},
static:{bw:function(a,b,c){var z=J.U(b)
if(!z.l())return a
...
x=J.n(this.gF(a))
w=J.n(this.gE(a))
return W.bL(W.G(W.G(W.G(W.G(0,z),y),x),w))},
$isa3:1,
$asa3:I.a7,
"%":";DOMRectReadOnly"},
cx:{
...
if(b===!0){z=[c]
C.a.U(z,d)
d=z}y=P.a1(J.cd(d,P.dI()),!0)
return P.a6(H.bo(a,y))},null,null,8,0,null,21,22,1,23],
...
z=J.h(a)
if(!!z.$isD)return a.a
if(!!z.$isas||!!z.$isad||!!z.$isaA||!!z.$isav||!!z.$isO||!!z.$isr||!!z.$isaH)return a
...
z=!!z.$isas||!!z.$isad||!!z.$isaA||!!z.$isav||!!z.$isO||!!z.$isr||!!z.$isaH}else z=!1
if(z)return a
...
k:["al",function(a,b,c){if(typeof b!=="string"&&typeof b!=="number")throw H.b(P.ar("property is not a String or num"))
this.a[b]=P.a6(c)}],
gp:function(a){return 0},
n:function(a,b){if(b==null)return!1
...
z=this.a
y=b==null?null:P.a1(new H.J(b,P.aX()),!0)
return P.aK(z[a].apply(z,y))},
static:{cI:function(a,b){var z=P.a6(a)
return P.ak(new z())},a0:function(a){return P.ak(P.a6(a))}}},
a_:{
"^":"D;a"},
ax:{
"^":"cJ;a",
...
"^":"k;",
$isr:1,
"%":";ArrayBufferView;aD|bh|bj|aE|bi|bk|F"},
e4:{
"^":"bl;",
$isr:1,
"%":"DataView"},
...
if(!!z.$isa_){if($.$get$aR().K(a))return $.$get$aR().i(0,a)
return E.aS(a,null)}if(!!z.$isb4){z=a.type
if(z==="track"){z=J.f(P.a0(a),"detail")
x=J.H(z)
return new Y.d6(x.i(z,"state"),x.i(z,"x"),x.i(z,"y"),x.i(z,"dx"),x.i(z,"dy"),x.i(z,"ddx"),x.i(z,"ddy"),x.i(z,"sourceEvent"),a,z,null)}if(z==="tap"){z=J.f(P.a0(a),"detail")
x=J.H(z)
return new Y.d5(x.i(z,"x"),x.i(z,"y"),x.i(z,"sourceEvent"),a,z,null)}if(z==="down"){z=J.f(P.a0(a),"detail")
x=J.H(z)
return new Y.cv(x.i(z,"x"),x.i(z,"y"),x.i(z,"sourceEvent"),a,z,null)}if(z==="up"){z=J.f(P.a0(a),"detail")
x=J.H(z)
...
v=P.be()
for(x=J.U(J.f(w,"Object").a5("keys",[a]));x.l();){u=x.gm()
v.k(0,u,E.bU(z.i(a,u)))}return v}return a},"$1","dN",2,0,0,24],
...
C.a.U(y,new H.J(z.G(a,new E.dK()),P.aX()))
return new P.ax(y)}else{y=H.dp(a,"$isB",[P.C,null],"$asB")
if(y){x=P.cI(J.f($.$get$Q(),"Object"),null)
z.t(a,new E.dL(x))
return x}else if(!!z.$isd7)return $.$get$c2().i(0,a)
else if(!!z.$isae)return new P.a_(P.bN(new E.dM(a),!0))}}return a},
...
if(z instanceof P.a_)return E.aS(z,this.gv())
return z},
k:function(a,b,c){J.ap(this.gv(),b,c)}},
dq:{
"^":"e:0;",
...
z=P.a6(this.b)
y=P.a1(new H.J([a,b,c,d,e,f,g,h,i,j],P.aX()),!0)
...
ae:function(a,b){return this.af(a,b,null)}}}],["","",,N,{
"^":"",
c3:function(){var z=P.E(["is","path-changes","properties",P.E(["company",P.E(["type",C.c,"value",P.E(["manager",P.E(["name","John"]),"secondManager",P.E(["name","Scott"])])])]),"observers",["userManagerChanged(company.manager.name)"],"userManagerChanged",new N.dP(),"attached",new N.dQ()])
$.$get$Q().a5("Polymer",[E.aY(z)])},
dP:{
"^":"e:2;",
$2:[function(a,b){P.dS("new manager name is "+H.a(b))},null,null,4,0,null,1,26,"call"]},
dQ:{
"^":"e:0;",
$1:[function(a){var z=J.R(a)
z.k(a,"company.manager.name","Scott")
z.k(a,"company.secondManager.name","John")},null,null,2,0,null,1,"call"]}},1]]
setupProgram(dart,0)
...
if(a instanceof P.c)return a
return J.aU(a)}
J.aT=function(a){if(typeof a=="number")return J.Z.prototype
if(a==null)return a
if(!(a instanceof P.c))return J.aG.prototype
return a}
J.du=function(a){if(typeof a=="number")return J.Z.prototype
...
return J.aT(a).M(a,b)}
J.f=function(a,b){if(a.constructor==Array||typeof a=="string"||H.c0(a,a[init.dispatchPropertyName]))if(b>>>0===b&&b<a.length)return a[b]
return J.H(a).i(a,b)}
...
J.b0=function(a,b){return J.H(a).D(a,b)}
J.cb=function(a,b){return J.R(a).B(a,b)}
J.cc=function(a,b){return J.R(a).t(a,b)}
J.n=function(a){return J.h(a).gp(a)}
J.U=function(a){return J.R(a).gA(a)}
J.V=function(a){return J.H(a).gj(a)}
J.cd=function(a,b){return J.R(a).G(a,b)}
...
C.i=I.an([])
C.y=I.an([])
C.j=H.a8(new H.cp(0,{},C.y),[P.a4,null])
C.A=new H.aF("call")
C.c=H.x("B")
C.k=H.x("ae")
C.l=H.x("ab")
...
try{(void 0).$method$($argumentsExpr$)}catch(z){return z.message}}())},"bD","$get$bD",function(){return H.v(H.bE(null))},"bC","$get$bC",function(){return H.v(function(){try{null.$method$}catch(z){return z.message}}())},"bI","$get$bI",function(){return H.v(H.bE(void 0))},"bH","$get$bH",function(){return H.v(function(){try{(void 0).$method$}catch(z){return z.message}}())},"P","$get$P",function(){return[]},"Q","$get$Q",function(){return P.ak(self)},"aJ","$get$aJ",function(){return H.bW("_$dart_dartObject")},"aI","$get$aI",function(){return H.bW("_$dart_dartClosure")},"aL","$get$aL",function(){return function DartObject(a){this.o=a}},"c2","$get$c2",function(){var z=$.$get$Q()
return P.E([C.D,J.f(z,"Number"),C.B,J.f(z,"Number"),C.m,J.f(z,"Number"),C.o,J.f(z,"Boolean"),C.n,J.f(z,"String"),C.p,J.f(z,"Array"),C.l,J.f(z,"DateTime"),C.c,J.f(z,"Object"),C.C,J.f(z,"Object"),C.k,J.f(z,"JsFunction")])},"aR","$get$aR",function(){var z=$.$get$Q()
return P.E([J.f(z,"Number"),C.m,J.f(z,"Boolean"),C.o,J.f(z,"String"),C.n,J.f(z,"Array"),C.p,J.f(z,"DateTime"),C.l,J.f(z,"Object"),C.c,J.f(z,"JsFunction"),C.k])},"aQ","$get$aQ",function(){return P.be()}])
I=I.$finishIsolateConstructor(I)
$=new I()
init.metadata=[null,"self","o","item","p1","p2","p3","p4","p5","p6","p7","p8","p9","p10","closure","isolate","numberOfArguments","arg1","arg2","arg3","arg4","callback","captureThis","arguments","js","element","manager"]
init.types=[{func:1,args:[,]},{func:1},{func:1,args:[,,]},{func:1,args:[P.C,,]},{func:1,args:[,P.C]},{func:1,args:[P.C]},{func:1,args:[P.a4,,]},{func:1,opt:[,,,,,,,,,,]},{func:1,args:[W.A],opt:[,,,,,,,,,,]},{func:1,ret:P.c,args:[,]}]
...
if(typeof dartMainRunner==="function")dartMainRunner(N.c3,[])
else N.c3([])})})()