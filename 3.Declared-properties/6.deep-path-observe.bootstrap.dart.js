...
"^":"",
c3:function(){return R.dP()}},1],["","",,R,{
"^":"",
dP:function(){var z=P.F(["is","deep-path-observe","properties",P.F(["company",P.F(["type",C.c,"value",P.F(["manager",P.F(["name","John"]),"secondManager",P.F(["name","Scott"])])])]),"observers",["userManagerChanged(company.manager.*)"],"userManagerChanged",new R.dQ(),"attached",new R.dR()])
$.$get$Q().a5("Polymer",[E.aY(z)])},
dQ:{
"^":"e:2;",
$2:[function(a,b){var z=J.D(b)
P.dT(H.a(z.i(b,"path"))+" changed to "+H.a(z.i(b,"value")))},null,null,4,0,null,1,26,"call"]},
dR:{
"^":"e:0;",
...
if(typeof dartMainRunner==="function")dartMainRunner(Z.c3,[])
else Z.c3([])})})()