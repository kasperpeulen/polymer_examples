...
dY:function(a){throw H.b(new P.cr("Cyclic initialization for static "+H.a(a)))},
...
"^":"",
c4:function(){return U.dQ()}},1],["","",,U,{
"^":"",
dQ:function(){var z=P.a_(["is","array-observation","properties",P.a_(["users",P.a_(["type",C.c,"value",[1,2,3]])]),"observers",["usersAddedOrRemoved(users.splices)","usersChanged(users.*)"],"ready",new U.dR(),"attached",new U.dS(),"usersAddedOrRemoved",new U.dT(),"usersChanged",new U.dU()])
...
if(typeof dartMainRunner==="function")dartMainRunner(Q.c4,[])
else Q.c4([])})})()