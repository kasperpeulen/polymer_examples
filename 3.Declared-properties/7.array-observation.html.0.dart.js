...
"^":"",
c4:function(){var z=P.a_(["is","array-observation","properties",P.a_(["users",P.a_(["type",C.c,"value",[1,2,3]])]),"observers",["usersAddedOrRemoved(users.splices)","usersChanged(users.*)"],"ready",new U.dQ(),"attached",new U.dR(),"usersAddedOrRemoved",new U.dS(),"usersChanged",new U.dT()])
...
if(typeof dartMainRunner==="function")dartMainRunner(U.c4,[])
else U.c4([])})})()